...
public class TratadorDeErros {
    ...
    @ExceptionHandler(ValidacaoException.class) //recebendo a exception que foi lançada por parametro
    public ResponseEntity tratarErrorRegraDeNegocio(ValidacaoException exception){
